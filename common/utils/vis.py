...
class H2O3DObjects():
    ...
    def get_obj_id_to_mesh(self):
        ...
        for id in self.obj_id_to_name.keys():
            ...
            assert os.path.exists(os.path.join(YCB_models_dir, obj_name, 'textured_simple.obj'))  # _2000.obj'))
            o3d_mesh = o3d.io.read_triangle_mesh(os.path.join(YCB_models_dir, obj_name, 'textured_simple.obj'))  # _2000.obj'))
