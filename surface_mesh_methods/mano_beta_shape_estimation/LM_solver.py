...
class LM_Solver():
    def __init__(self, num_Iter=500, th_beta=None, th_pose=None, lb_target=None,
                 weight=0.01,_mano_root='sources/mano/models'):
        self.count = 0
        ...
        self.mano_layer = ManoLayer(side="right",
                                    mano_root='sources/mano/models', use_pca=False, flat_hand_mean=True)
    ...
    def update(self, beta_):
        ...
        useful_lb = caculate_length(joints, label="useful")
        lb_ref = useful_lb[6]
