...
from keypoint_transformer.nets.layer import MLP
from keypoint_transformer.nets.module import BackboneNet, DecoderNet, DecoderNet_big
from keypoint_transformer.nets.transformer import Transformer
from keypoint_transformer.nets.loss import *
from keypoint_transformer.nets.position_encoding import build_position_encoding
from keypoint_transformer.utils.preprocessing import PeakDetector
from keypoint_transformer.utils.misc import *
import numpy as np
import time
...
class Model(nn.Module):
    def __init__(self, backbone_net, decoder_net, transformer, position_embedding):
        ...
        self.norm1 = nn.LayerNorm(cfg.mutliscale_dim)  # AttributeError: 'Config' object has no attribute 'mutliscale_dim'. Did you mean: 'calc_mutliscale_dim'
    ...
    def forward(self, inputs, targets, meta_info, mode, epoch_cnt=1e8):
        ### function that delivers kypt trafo out ###
        ...
        if cfg.predict_type == 'angles':
            ...
            if cfg.predict_2p5d:
                ...
                self.joint_vecs_loss(joint_vecs, targets['joint_cam_no_trans'], meta_info['joint_valid'], targets['joint_coord'][:,:,:2],
                                     cam_param, rel_trans)  # where stuff happens
