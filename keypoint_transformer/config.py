...
import sys
from keypoint_transformer.utils.dir import add_pypath, make_folder
import torch
import random
import numpy as np
import os
...
class Config:
    ...
    #~~~~~~~~~~~~~~~~~~~~~~SMPLX path~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    smplx_path = 'sources/mano/models/' # Path to MANO model files
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#SS


    # ~~~~~~~~~~~~~~~~~~~~~~InterHand2.6M paths~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    #interhand_anno_dir = ''
    #interhand_images_path = ''
    ...
    # ~~~~~~~~~~~~~~~~~~~~~~H2O-3D paths~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    h2o3d_anno_dir = base_path + '/sources/H2O3D'
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#


    # ~~~~~~~~~~~~~~~~~~~~~~Object Model paths~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    object_models_dir = 'sources/YCB_Video_Models/models'
    # ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
    ...
    obj_kps_dir = 'sources/ho3d_object_kps'
