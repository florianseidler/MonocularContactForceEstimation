...
from .dataset_ho3d import Dataset

from keypoint_transformer.timer import Timer
from keypoint_transformer.logger import colorlogger
from torch.nn.parallel.data_parallel import DataParallel
from keypoint_transformer.model import get_model
...
class Base(object):
    ...
    @abc.abstractmethod
    def _make_single_frame_generator(self):
        return
