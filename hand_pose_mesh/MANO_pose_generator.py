...
from .MANO_pose_generator_functions import (calc_mano_2_world, calc_mano_geometries,
                                            apply_kypt_estimator, get_hand_state)
...
def generate_mano_mesh_from_kypt(img_path, seq_dir, frame):
    ...
    return mano_mesh, mano_translation  # , hand_state


def get_kypt_mesh(kypt_3d_joints):

    hand_pose, m0_translation = get_hand_state(kypt_3d_joints)
    ...
    return mano_mesh, m0_translation, hand_state
