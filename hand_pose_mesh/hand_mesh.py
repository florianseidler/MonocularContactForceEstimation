...
HAND_MESH_MODEL_LEFT_PATH_JSON = '/sources/mano/models/mano_hand_mesh_left.json'
HAND_MESH_MODEL_RIGHT_PATH_JSON = '/sources/mano/models/mano_hand_mesh_right.json'

OFFICIAL_MANO_LEFT_PATH = '/sources/mano/models/mano/MANO_LEFT.pkl'
OFFICIAL_MANO_RIGHT_PATH = '/sources/mano/models/mano/MANO_RIGHT.pkl'
...
class HandMesh():
  ...
  """
    ...
    def __init__(self, left=True):
        ...
        base_path = os.getcwd()  
        if left:
            with open(base_path + HAND_MESH_MODEL_LEFT_PATH_JSON, "r") as f:
                model_kwargs = json.load(f)
        else:
            with open(base_path + HAND_MESH_MODEL_RIGHT_PATH_JSON, "r") as f:
                model_kwargs = json.load(f)
